...
**Widget Enregistré par moi**

* **Administrateur :** les administrateurs peuvent placer le widget Enregistré par moi sur une page afin que les élèves puissent facilement trouver le contenu qu&#39;ils ont marqué d&#39;un signet. Cela permet aux élèves de revenir aux cours qu’ils avaient enregistrés précédemment sans avoir à les rechercher ou à y accéder à nouveau. En savoir plus sur le widget [Enregistrer par moi](/help/migrated/administrators/feature-summary/experience-builder/add-a-widget.md#bookmark-widget).

* **Élève :** le widget **Enregistré par moi** affiche les cours, les parcours d&#39;apprentissage, les certifications et les assistances à la tâche pour lesquels vous avez ajouté des signets ultérieurement. Utilisez ce widget pour accéder rapidement au contenu enregistré au même endroit, sans avoir à effectuer de nouvelle recherche dans le catalogue. En savoir plus sur le widget [Enregistrer par moi](/help/migrated/learners/feature-summary/saved-by-me-widget.md).

**Couleur de thème de canal :** lorsque vous créez un canal, vous avez d’autres couleurs de thème de canal parmi lesquelles choisir. Les couleurs du thème sont appliquées de manière contextuelle pour mettre en évidence le contraste après votre sélection. Lorsque vous sélectionnez une couleur de thème pour la couche, la couleur sélectionnée est appliquée à l’interface de la couche et est conçue pour conserver un contraste avec les vignettes et le texte de la couche. Une couleur par défaut est automatiquement attribuée lors de la création d’une couche, mais vous pouvez à tout moment choisir une autre couleur dans les options disponibles.

**Vignettes vidéo :** l’élève peut désormais identifier rapidement une vidéo par sa vignette, qui à son tour affiche une vignette pour aider à identifier son contenu en un coup d’œil. Si la vidéo source ne fournit pas sa propre image miniature, Adobe Learning Manager en génère automatiquement une à l’aide de la couleur du thème de la couche, d’un motif abstrait et du titre de la vidéo.

**Canaux :** l&#39;option de navigation Canaux est visible par les élèves uniquement lorsqu&#39;au moins un canal a été créé, contient au moins une vidéo de sa source et est marquée Visible par les élèves. En savoir plus sur les [canaux](/help/migrated/administrators/feature-summary/create-channels.md).

## Corrections de bugs

**Composant Adobe Experience Manager :** après la mise à niveau vers le package du site de référence Adobe Learning Manager v2.0.1, le panneau Notifications n&#39;a pas pu se charger lorsque les utilisateurs ont cliqué sur la cloche de notification. Le chargeur a continué de tourner indéfiniment, empêchant l’affichage des notifications. Le problème a également provoqué des appels répétés au point de terminaison /userNotifications, ce qui a finalement entraîné des réponses HTTP 429. Le flux de travail de chargement des notifications a été corrigé pour éviter des demandes d’API excessives et résoudre le problème de chargement. Les notifications se chargent désormais correctement et le panneau s’ouvre comme prévu sans limitation d’API inutile.

**Application mobile Adobe Learning Manager > Parcours d’apprentissage :** les cours terminés dans un parcours d’apprentissage de l’application mobile Adobe Learning Manager ne s’affichaient pas correctement avec un indicateur jaune et un point rouge, même si leur état était marqué comme terminé. Cette incohérence visuelle se produisait uniquement pour les cours dans les parcours d’apprentissage, tandis que les modules terminés s’affichaient correctement. La logique de l’indicateur d’état a été corrigée pour les cours du parcours d’apprentissage dans l’application mobile. Les cours terminés affichent désormais l’indicateur vert d’achèvement correct. Cela garantit une expérience d’achèvement cohérente dans l’application mobile et le navigateur de bureau.

+++


+++Mise à jour 110 : version du 16 août 2026 de Adobe Learning Manager

## Annuler les tons clairs

La version d’août 2026 de Adobe Learning Manager offre des avancées significatives en matière d’apprentissage personnalisé, d’IA, de création de rapports et d’intégrations.
...
**Remplacement VTT bloqué par la limite de caractères :** correction d’un problème en raison duquel l’utilisateur ne pouvait pas remplacer le fichier VTT généré automatiquement par ALM en raison de la limite de caractères en mode révision/édition. La limite de caractères a été portée à un million en mode de montage VTT.
...
La version d’avril 2026 de Adobe Learning Manager introduit des améliorations concernant l’expérience des élèves, l’administration, la création de contenu et la création de rapports, avec plusieurs fonctionnalités actuellement en version Beta et susceptibles d’être modifiées.

**Améliorations de l’expérience de l’élève**

* Navigation améliorée dans le lecteur Fluidic avec un libellé « Module suivant » clair et une action de sortie dédiée pour un meilleur flux de cours.
* Prise en charge multilingue étendue aux assistances à la tâche, aux listes de contrôle et aux sous-titres vidéo.
* Assistant IA intégré à l’expérience d’apprentissage pour fournir une aide contextuelle.
* Expérience améliorée du contenu du Captivate avec une table des matières unifiée, des indicateurs d’achèvement et une exportation améliorée des notes.
* Prise en charge de la configuration de la langue du lecteur via LTI pour une expérience multiplateforme cohérente.
...
* Introduction d’un Experience Builder non connecté pour créer des pages d’apprentissage publiques.
* Les cours partagés affichent désormais correctement l’auteur original.

**Capacités de l’instructeur**

* Génération de code QR pour l’inscription à la session et le suivi de la présence.
* Possibilité de fournir des commentaires et des rétroactions pendant les évaluations de la liste de contrôle.

**Améliorations des rapports et des analyses**

* Amélioration des rapports SCORM pour capturer plusieurs tentatives de quiz.
* Calcul plus précis du temps d&#39;apprentissage dans les relevés de notes des élèves.
* Mises à jour des rapports de relevé de notes pour les administrateurs.
* Amélioration de la fonctionnalité de recherche avancée.

**Équivalents et variantes**

* Des améliorations apportées aux équivalents et aux variantes améliorent la flexibilité des parcours d’apprentissage en permettant une substitution et une mise en correspondance des cours plus précises.

**Impact clé**
Ces mises à jour améliorent la convivialité, l’évolutivité et l’automatisation, en mettant l’accent sur l’apprentissage assisté par l’IA, le support multilingue, la gestion rationalisée des formations virtuelles et des rapports plus précis.

Pour plus d&#39;informations, consultez les [Nouveautés et modifications de la version d&#39;avril 2026 de Adobe Learning Manager](/help/migrated/whats-new.md).

## Bogues corrigés dans cette version

**Recherche avancée :** la recherche avancée n&#39;a pas respecté l&#39;accès LO en fonction de l&#39;inscription des utilisateurs lorsque l&#39;accès au catalogue était manquant. La recherche avancée applique désormais les mêmes vérifications d’accès basées sur l’inscription que la recherche lexicale, ce qui permet aux utilisateurs inscrits d’accéder à l’objet d’apprentissage sans accès au catalogue.

**Adobe Experience Manager :** l&#39;en-tête du widget de catalogue n&#39;a pas conservé le catalogue sélectionné et a ouvert la page du catalogue avec tous les objets d&#39;apprentissage au lieu du catalogue filtré. Cliquer sur un en-tête de widget de catalogue ouvre désormais la page du catalogue avec le catalogue correspondant présélectionné et les objets d&#39;apprentissage correctement filtrés dans ce catalogue.

**Application mobile de l&#39;appareil :** sur mobile, les élèves pouvaient terminer tous les éléments de la première section d&#39;un parcours d&#39;apprentissage ordonné, mais la deuxième section ne se déverrouillait pas même après la réussite de l&#39;accomplissement. Une fois que tous les éléments d’une section sont terminés sur mobile, la section suivante d’un parcours d’apprentissage ordonné se déverrouille désormais correctement pour l’élève.

**Migration LMS :** lorsqu&#39;une instance de cours créée via la migration avait un ID d&#39;instance alphanumérique, la réexécution de la migration pour mettre à jour une session VC créait une nouvelle session au lieu de mettre à jour la session existante. La migration met désormais correctement à jour les sessions VC existantes pour les instances de cours avec des ID alphanumériques au lieu de créer des sessions en double.
...
**Performances :** un workflow d’automatisation AWS a envoyé à plusieurs reprises des demandes de téléchargement mal codées (avec un espace non codé) à l’API HTTP du système de gestion de contenu Akamai CMS, ce qui a provoqué des pics de 500 erreurs et un trafic excessif non valide. Le workflow automatisé code désormais correctement les espaces dans l’URL de téléchargement, ce qui empêche les demandes non valides et élimine les 500 pics d’erreur associés.

**Inscription et désinscription :** dans certains flux d&#39;inscription d&#39;administrateur pour les programmes d&#39;apprentissage, les certifications et les cours, la source d&#39;inscription a été incorrectement enregistrée en tant que SELF_ENROLL au lieu de ADMIN_ENROLL. Les inscriptions pilotées par les administrateurs sont désormais stockées de manière cohérente avec ADMIN_ENROLL source sur l’ensemble des flux concernés.

**Inscription et désinscription :** pour les inscriptions basées sur un seuil dans une chaîne de périodicité des certifications, les élèves étaient inscrits dans une périodicité ultérieure même lorsqu&#39;ils n&#39;avaient pas terminé la périodicité précédente. L&#39;inscription basée sur un seuil respecte désormais la chaîne de périodicité, et les élèves ne sont pas inscrits à une certification ultérieure à moins d&#39;avoir terminé la périodicité précédente requise.

**Paramètres d&#39;administration :** les administrateurs n&#39;ont pas pu ajouter de compte de pairs dont le sous-domaine commençait par un nombre, en raison d&#39;une règle de validation exigeant que le sous-domaine commence par une lettre. Les comptes de pairs dont les sous-domaines commencent par un nombre sont désormais acceptés, à condition qu’ils respectent les règles de caractère autorisées.

**Cours - Score du quiz :** lors du lancement sans en-tête, après qu&#39;un administrateur a réinitialisé un module de quiz, le lecteur a affiché un total incorrect de 12 questions au lieu des 3 questions réelles. Dans le lancement sans en-tête, le lecteur de quiz affiche désormais le nombre total correct de questions après une réinitialisation du module.

**Auteur :** lorsqu&#39;un groupe de contenus a été mis à jour de SCORM vers CAPI, les informations de rapport et les critères d&#39;achèvement n&#39;ont pas été actualisés, laissant le groupe de contenus sans critères d&#39;achèvement. La mise à jour d&#39;un groupe de contenus de SCORM vers CAPI met désormais correctement à jour les informations de rapport et définit les critères d&#39;achèvement appropriés pour le groupe de contenus.

**Application mobile de l&#39;appareil :** dans l&#39;application mobile Captivate Prime, les ressources téléchargeables qui s&#39;ouvraient dans un nouvel onglet via target=« _blank » ne se téléchargeaient pas lorsqu&#39;elles étaient touchées. Dans l’application mobile, appuyer sur une ressource téléchargeable lance désormais correctement le téléchargement, même lorsque le contenu utilise des liens target=« _blank ».

**Éditeur de texte enrichi :** les sauts de ligne dans les descriptions d&#39;objet d&#39;apprentissage de texte enrichi ont été supprimés dans la vue de l&#39;auteur après la publication, même si les élèves ont toujours vu les sauts de ligne. Les descriptions d’objet d’apprentissage en texte enrichi conservent et affichent désormais correctement les sauts de ligne dans les vues Auteur et Élève.

## Problème connu/Par conception

### Comportement de contrôle de version pour les ressources Second Nature

Adobe Learning Manager (ALM) n’incrémente pas la version des ressources Second Nature (SN) lors des scénarios de modification. Ce comportement reflète la façon dont ALM gère les mises à jour de contenu SN plutôt que le choix de la création.
...
+++Mise à jour 104 : Assistant IA pour les élèves dans Adobe Learning Manager

Date de publication : 2 mars 2026

## Assistant d’IA pour les élèves

Un outil de conversation alimenté par GenAI conçu pour aider vos élèves à trouver des réponses, des ressources et des cours pertinents instantanément à l&#39;aide de requêtes en langage naturel.
...
* Nous avons renommé la chaîne Évaluer cette formation en la remplaçant par Évaluer ce cours, Évaluer ce parcours d’apprentissage ou Évaluer cette certification, en fonction de la formation suivie. Selon le type de formation, un élève voit la chaîne en conséquence.
...
* Lorsqu’un fichier CSV contenant un grand nombre d’enregistrements est en cours de traitement, cela prend un temps considérable. Si un utilisateur se connecte et saisit une valeur pour l’un des attributs, cela peut créer un nouveau groupe d’utilisateurs qui peut entraîner des erreurs dans le fichier CSV. Pour résoudre ce problème, lorsque l’importation CSV est en cours, le message contextuel de l’attribut Champs actifs est désactivé et réactivé une fois le chargement CSV terminé.
...
* Modifiez GetNotificationData de GET en POST. L&#39;implémentation d&#39;origine a produit l&#39;erreur **IllegalArgumentException : l&#39;en-tête de demande est trop volumineux**, ce qui a entraîné l&#39;échec des notifications.
+++
...
* Une nouvelle colonne, Terminé par, est ajoutée aux rapports LT. Cela permet à l’administrateur d’identifier la source d’achèvement d’un objet d’apprentissage.
...
**Remarque :** avec cette version de Adobe Learning Manager, les utilisateurs disposant de comptes inactifs ne peuvent plus accéder à leurs comptes à l’aide de sous-domaines. Les comptes sont accessibles à l’aide de l’ID de compte ou via la page acapindex.html en saisissant l’ID de messagerie.
...
* Corrections apportées aux terminologies du produit dans quelques rapports de tableau de bord.
...
Une [instance](https://learningmanagerapac.adobe.com/acapindex.html) de Learning Manager est désormais hébergée sur AWS à Mumbai (ap-south-1). Pour les clients utilisant cette instance en Inde, les informations d’identification personnelle (PII) et les dossiers d’apprentissage de l’utilisateur sont stockés uniquement en Inde.
...
* En tant qu’administrateur, les dates de début et de fin d’une annonce n’étaient pas enregistrées si l’interface et le langage de contenu étaient définis sur Deutsch/Espanol. Ce problème a été résolu.
...
* En Europe, le contenu Learning Manager directement publié sur Adobe Learning Manager à partir d’Adobe Learning Manager était publié en langue allemande par défaut. Ce problème est maintenant corrigé.
...
La version **d’octobre 2021 d&#39;Adobe Learning Manager** introduit le concept de parcours d’apprentissage.
...
Les parcours d’apprentissage remplacent notre fonction existante des programmes d’apprentissage. Imaginez que les programmes d’apprentissage bénéficient d’améliorations puissantes sans abandonner les fonctionnalités existantes. En outre, la fonction est marquée comme un parcours d’apprentissage.
...
* Les modèles de courrier électronique, tels que Annulation de cours, Annulation du programme d’apprentissage ou Annulation de la certification, ne reflètent pas les dernières terminologies de produit définies dans le fichier csv. Désormais, le texte par défaut dans les modèles de courrier électronique prend en charge les terminologies personnalisées.
* La langue utilisateur dans Learning Manager n’est pas prise en charge dans la procédure Publier vers Learning Manager. Si la langue de l’utilisateur est différente, l’option Publier sur Learning Manager apparaît en anglais.
* Si vous ajoutez de nombreux catalogues à un rôle personnalisé, une erreur se produit lorsque vous mettez à jour le rôle. Désormais, le nombre maximal de catalogues est augmenté jusqu’à 50.
...
* Obtention et stockage en externe des e-mails/jetons utilisateur afin que les utilisateurs puissent mettre en oeuvre leur propre back-end de stockage au lieu d&#39;utiliser les nœuds utilisateur AEM.
...
La **version d&#39;août 2021** **d&#39;Adobe Learning Manager** met l&#39;accent sur l&#39;amélioration des processus liés à l&#39;expérience de l&#39;élève, à la création de rapports et aux tâches administratives. Voici quelques-uns des points forts :

* **Marché de contenus :** Learning Manager propose désormais plus de 70 000 cours dans divers domaines comme la technologie, le management, le leadership, etc.
* **Prise en charge de l&#39;accessibilité améliorée :** la prise en charge de l&#39;accessibilité pour le rôle de l&#39;élève est renforcée par une navigation au clavier améliorée, la possibilité d&#39;utiliser un lecteur d&#39;écran, et le respect du rapport de contraste.
* **Formatage de texte enrichi :** Learning Manager propose désormais l&#39;édition de texte enrichi pour les descriptions de cours, de programmes, de certificats et d&#39;assistances à la tâche. Cela permet aux auteurs de spécifier des descriptions en texte enrichi, y compris des hyperliens, des images et d&#39;autres options de formatage du texte, au lieu d&#39;utiliser du texte brut.
* **Évaluation par étoiles :** un élève peut désormais noter un cours sur une échelle de 5 points. Un administrateur peut choisir entre l&#39;évaluation de l&#39;efficacité existante ou l&#39;évaluation à 5 étoiles.
* **Intégration de Badgr :** les élèves peuvent désormais autoriser Learning Manager à envoyer automatiquement les badges qu’ils ont acquis dans Learning Manager vers leur compte Badgr, où ils peuvent les partager sur leurs réseaux sociaux.
...
* Possibilité pour les administrateurs et la direction de consulter les approbations en attente pour les cours. Cela permet à la direction de s’assurer que les responsables suivent l’apprentissage et la formation des employés, et permet également aux administrateurs Learning Manager d’approuver l’inscription aux cours selon les besoins.
...
La mise à jour 3.3 de l’application mobile Captivate Learning Manager introduit une toute nouvelle page d’accueil, qui prend en charge les en-têtes et les recommandations de formation basées sur l’IA. Cette page d’accueil est disponible pour tous les comptes configurés pour la nouvelle option de mise en page immersive. Les comptes configurés avec la mise en page classique continuent d’afficher l’ancienne page d’accueil classique. Leur page d’accueil ne devrait comporter aucune modification.

En outre, cette mise à jour permet également aux élèves de télécharger leur badge au format PDF et sous forme d’image. La mise à jour introduit également une fenêtre contextuelle de retour d’informations, qui permet aux élèves de fournir des commentaires anonymes sur l’application.
...
Pour tous les comptes pour lesquels l’option de mise en page immersive est activée, une toute nouvelle page d’accueil prend en charge la configuration de mise en page immersive.
...
* Les cours retirés n’apparaissent pas dans les résultats de la recherche comme prévu. Ce problème a été résolu.
...
* Un chargement de fichier CSV échoue si les champs actifs contiennent des caractères spéciaux. Ce problème a été résolu.
...
* Pour un type spécifique de contenu SCORM-2004, le scénario de reprise ne fonctionnait pas. Par conséquent, les élèves devaient naviguer jusqu&#39;au point où ils s&#39;étaient arrêtés. Ce problème est maintenant corrigé. Le contenu devrait maintenant reprendre à partir du point où vous l&#39;aviez laissé.
...
* Lors de l&#39;exportation d&#39;un rapport de groupe d&#39;utilisateurs comptant plus de 500 utilisateurs, les valeurs de données et les en-têtes de colonnes du rapport ne correspondaient pas, ce qui est maintenant corrigé.
...
* Dans l&#39;**application d&#39;administration > Catalogue > rechercher un catalogue**, vous ne pouvez pas effectuer de recherche.
...
* Un badge personnalisé dont le libellé de catalogue comporte un espace empêche le fichier pdf de se télécharger comme prévu.
...
Dans cette mise à jour, vous pouvez également modifier l&#39;image de bannière d&#39;un objet d&#39;apprentissage.
...
* Dans la boîte de dialogue **Ajouter un rapport**, les sélecteurs **Intervalle de temps** et **Filtres** apparaissent comme des sections distinctes, qui sont réduites par défaut. Pour plus d&#39;informations, voir [***Création de rapports***](../administrators/feature-summary/reports.md#report).
...
Dans les colonnes de temps des relevés de notes des élèves, les minutes sont arrondies à la minute la plus proche et la valeur de seconde est de 00. Pour plus d&#39;informations, voir [***Colonnes de temps***](/help/migrated/administrators/feature-summary/reports/learner-transcripts.md).
...
* Dans un cas particulier, pour une session, le calendrier d’apprentissage affichait l’état **Inscrit** même lorsque l’élève avait terminé le cours.
...
Mappez les compétences de votre compte avec les domaines de compétence présents dans le système LMS Learning Manager. Cela permet d’associer les compétences de votre compte aux domaines de compétence que Learning Manager prend en charge pour la curation à assistance automatique. Pour plus d’informations, voir [***Mappage de compétences avec les domaines***](../administrators/feature-summary/curation-skills.md).
...
* Lorsqu&#39;un responsable a sélectionné l’option **Ce trimestre**, l&#39;inscription, la progression et les détails de l&#39;achèvement d&#39;un objet d&#39;apprentissage ne seront pas affichés. Dans cette version, ces détails s&#39;affichent désormais comme prévu.
...
* Fonctions d&#39;édition complètes des objets d&#39;apprentissage acquis via un catalogue partagé. Pour plus d&#39;informations, voir [***Contrôle du catalogue partagé***](../administrators/feature-summary/shared-catalog-full-control.md). Pour activer cette fonctionnalité, contactez l&#39;assistance de Learning Manager.
* Les instructeurs peuvent maintenant identifier facilement les sessions et les modules avec des révisions en attente. Pour plus d&#39;informations, voir [***Révisions en attente***](../instructors/feature-summary/learners.md#pending).
...
* L&#39;inscription des utilisateurs peut se faire de manière incorrecte lorsqu&#39;ils sont retirés d&#39;un groupe d&#39;utilisateurs. Ce problème a été résolu.
...
* La certification est manquante dans le menu déroulant du rapport du tableau de bord bien qu&#39;elle soit visible dans l&#39;application du responsable et dans la liste de l&#39;API de données. Ce problème a été résolu.
* Certains objets d’apprentissage n’ont pas pu être retirés par l’administrateur en raison d’un manque d’autorisation bien que les catalogues partagés soient indépendants des comptes Learning Manager. Ce problème a été résolu.
...
* L&#39;insertion des notifications des utilisateurs peut échouer de manière aléatoire, entraînant la non-remise des courriers électroniques associés. Ce problème a été résolu.
...
* Cette version d&#39;Adobe Learning Manager propose de nouvelles fonctions et des améliorations. Cela vous permet de créer des rôles personnalisés, d’ajouter des étiquettes de catalogue, de purger les utilisateurs, de gérer les étiquettes, de renommer les objets d&#39;apprentissage, d&#39;intégrer Slack, de procéder à de nouvelles intégrations de connecteurs, de prendre en charge xAPI, et bien plus encore. Pour plus d&#39;informations sur les nouvelles fonctionnalités et les améliorations, voir [Résumé des nouvelles fonctionnalités](../whats-new.md#main-pars_text).
...
* Le lien hypertexte vers le numéro de cours et de certifications à l&#39;intérieur du modèle de balises comprend les cours fantômes et les certifications récurrentes. Lorsque vous cliquez sur le lien hypertexte, ces cours et certifications peuvent ne pas figurer sur la liste, ce qui entraîne un décalage dans les numéros.
...
* Learning Manager affiche l’heure au format 24 heures dans les e-mails. Ce problème a été résolu. L&#39;heure est désormais affichée au format 12 heures.
...
* L’instructeur peut ne pas être en mesure de marquer la présence de tous les utilisateurs en une seule fois pour les sessions qui font partie du Programme d’apprentissage/Certification. Ce problème est résolu.
...
**Problème :** accéder à certains objets d&#39;apprentissage via Internet Explorer v11.1478.10586.0 peut faire planter Learning Manager.

**Solution de contournement :** mettez à jour votre navigateur Internet Explorer 11 vers la dernière version en contactant l&#39;équipe informatique de votre entreprise.
...
* Lorsque le catalogue par défaut est désactivé et qu&#39;un nouveau catalogue est créé, et si le responsable a accès à ce catalogue nouvellement créé, il peut ne pas être en mesure de rechercher des cours sous ce catalogue. Ce problème a été résolu.
* Les utilisateurs d&#39;applications mobiles peuvent ne pas recevoir les commentaires L1 sous forme de notifications Push. Ce problème a été résolu.
...
* Les modifications apportées à un cours partagé peuvent ne pas être transmises au compte partagé si l&#39;auteur du compte d&#39;origine enregistre automatiquement le cours. Ce problème a été résolu.
...
* Certains courriers électroniques de Learning Manager comme les courriers électroniques sans aucune donnée de notification n’étaient pas déclenchés pour les utilisateurs. Exemple : Courrier électronique reçu lors de la création et de l&#39;activation du profil externe et Courrier électronique reçu lors de la configuration d&#39;un compte de connexion. Ce problème a été résolu.
...
* Dans certains cas, après l&#39;ajout d&#39;un programme d&#39;apprentissage à un catalogue, l&#39;option d&#39;ajout peut encore être activée. Ce problème a été résolu.
* L’ouverture de Learning Manager dans un navigateur de périphérique affiche une option pour découvrir Learning Manager sur l’application pour appareil. Cliquez sur Oui pour lancer le Play Store (Android) si l’application n’est pas installée, ou l’application si elle est installée (Android et iOS). Ce flux a rencontré des problèmes et a été corrigé.
...
Le montage chronologique du tableau des scores de ludification d&#39;un élève interne pouvait afficher un élève externe lorsqu&#39;il était changé d&#39;un élève externe en élève interne. Ce problème a été résolu.
...
* Lorsqu&#39;un code QR était scanné pour les modules CR et VC à l&#39;aide de l&#39;application pour appareil Learning Manager.
...
* Lorsqu&#39;il cliquait sur la table des matières, elle pouvait ne pas se réduire automatiquement et devait être fermée manuellement pour afficher le contenu. Ce problème a été résolu.
...
* La table des matières ne se fermait pas automatiquement lorsque l&#39;orientation de l&#39;appareil était modifiée. Ce problème a été résolu.
...
* Si un utilisateur n&#39;avait téléchargé aucune assistance à la tâche, le fait de cliquer sur l&#39;onglet Mes assistances à la tâche en mode hors ligne pouvait bloquer l&#39;application sous iOS, auquel cas un message s&#39;affichait sous Android pour indiquer une erreur de chargement des données. Ce problème a été résolu.
...
* Parfois, une tentative de suppression d&#39;une assistance à la tâche déjà ajoutée à partir de l&#39;onglet Assistances à la tâche affichait un message d&#39;erreur. Ce problème a été résolu.
...
Les rappels d&#39;échéance mentionnaient de manière erronée le nombre de jours restants pour des élèves dans certains fuseaux horaires. Ce problème a été résolu.

**Problèmes de programme d’apprentissage dans le cas d’une instance expirée de programme**
...
Lorsqu’ils créent des objets d’apprentissage, les auteurs et les administrateurs peuvent désormais spécifier des ID uniques pour les cours, programmes d’apprentissage ou certifications. Si vous souhaitez activer l’ID unique lors de la création d’un objet d’apprentissage, cliquez sur Paramètres > Général. Cochez la case Activer en regard de l’option ID d’objets d’apprentissage uniques.

**Forum de discussion pour les élèves**

Utilisez le forum de discussion disponible dans les cours pour interagir avec vos homologues et formateurs. En tant qu’élève, vous pouvez voir toutes les publications concernant les cours. Toutefois, vous ne pouvez supprimer que les publications que vous avez saisies. Pour plus d&#39;informations sur le forum de discussion, voir [Affichage et participation aux discussions](../learners/feature-summary/courses.md#main-pars_header_1772461149).
...
Dans Adobe Learning Manager, vous pouvez désormais ajouter des types de livraison pour vos cours.
...
Dans Learning Manager, plusieurs auteurs peuvent désormais modifier simultanément le même groupe de contenus.

**Améliorations d’Adobe Connect**

Vous pouvez maintenant configurer une URL Adobe Connect unique avec plusieurs comptes Learning Manager.
...
* Dans un rôle d’élève, l’efficacité de cours s’affichait parmi l’une des options du filtre **Trier par** même lorsqu’un administrateur désactivait l’efficacité de cours pour les élèves. Ce problème a été résolu.
...
* Les brouillons des cours étaient également renvoyés lorsque l&#39;administrateur essayait de récupérer tous les cours.Ces brouillons de cours sont censés être réservés à l&#39;auteur. Ce problème a été corrigé, les brouillons des cours ne sont désormais plus renvoyés.
...
Nous avons également amélioré le modèle utilisateur existant en ajoutant les éléments suivants :
...
Learning Manager vous fournit une fonctionnalité permettant de générer des relevés de notes pour les élèves Learning Manager de votre organisation. Pour plus d&#39;informations, consultez le [contenu d&#39;aide sur les relevés de notes des élèves](/help/migrated/administrators/feature-summary/reports/learner-transcripts.md).
...
* Après avoir ajouté un groupe d’utilisateurs externes à Learning Manager, vous pouvez également suspendre le processus d’inscription des utilisateurs externes. À tout moment, vous pouvez toujours révoquer le blocage (pause) en sélectionnant une option reprendre.
...
* Vous pouvez vous abonner aux rapports de cours, de programme d’apprentissage ou de certification. Vous pouvez également vous abonner aux rapports de cours individuels pour des données telles que le score du quiz et le statut de l&#39;élève. Les abonnements seront envoyés sur votre ID de messagerie enregistré sur le compte Learning Manager. Vous pouvez aussi modifier cet ID de messagerie.
* Lorsque vous exportez le rapport d&#39;inscription de certification, une nouvelle colonne nommée **Date d&#39;échéance** est également exportée. Les données de cette colonne permettent aux administrateurs de savoir quels sont les élèves qui ont dépassé la date limite de suivi de leur objet d’apprentissage.
...
* Lorsqu&#39;un cours Presenter avec un titre contenant une apostrophe (&#39;) est publié et affiché dans Learning Manager, des points d&#39;interrogation ( ???) s&#39;affichent s’affichait dans la table des matières. Ce problème a été résolu.
...
Vous pouvez renouveler la période de validité des certifications en mois en mentionnant la valeur dans le champ **Validité**. Auparavant, le renouvellement de certification était uniquement autorisé en années.
...
* Le message suivant a été inclus dans la page d’enregistrement des utilisateurs externes : **Les utilisateurs doivent s’enregistrer et créer un nom d’utilisateur et un mot de passe pour les connexions ultérieures.**
...
* Quand un élève externe essayait d&#39;ouvrir les modules préparatoires ou de test par le biais du lien **Ouvrir les annotations** dans le courrier électronique de notification de nouveau suivi d&#39;un cours, le contenu des annotations n&#39;était pas visible. Ce problème a été résolu.
...
Lorsqu&#39;un élève externe cliquait sur le lien **Ouvrir les notes** dans l&#39;e-mail de notification de nouveau suivi d&#39;un cours, cela ne fonctionnait pas. Ce problème a été résolu. Ce lien ouvre le lecteur avec les annotations, même si l&#39;utilisateur n&#39;est pas connecté à Learning Manager.
...
Les noms de titre dans les modèles de courrier électronique n’étaient pas appropriés. Le contenu de ces titres de modèle a été mis à jour afin de les rendre lisibles.
...
Les administrateurs peuvent définir l’étendue de la ludification en modifiant les paramètres de l’étendue. Vous pouvez activer la ludification de manière sélective parmi des utilisateurs de profils semblables, des groupes ou un emplacement. Reportez-vous à la fonctionnalité de [ludification](../learners/feature-summary/gamification.md) pour plus d&#39;informations.
...
Vous pouvez désormais supprimer des cours aux étapes Brouillon et Retiré. Reportez-vous à la fonctionnalité [Cours](../administrators/feature-summary/courses.md) pour plus d&#39;informations. Si un objet d&#39;apprentissage est supprimé, toutes les données de rapport associées sont également supprimées. Dans le cas où un cours est supprimé et s&#39;il faisait partie de tout autre objet d&#39;apprentissage, un message approprié s&#39;affiche pour l&#39;utilisateur.

**Programmes et plans d’apprentissage**

Vous pouvez imposer l’ordre dans lequel les élèves peuvent suivre des cours dans le cadre des programmes d’apprentissage. Vous pouvez supprimer des programmes d’apprentissage aux étapes Brouillon et Retiré. Si un objet d&#39;apprentissage est supprimé, toutes les données de rapport associées sont également supprimées.

**Certifications**

Vous pouvez supprimer des certifications aux étapes Brouillon et Retiré. Si un objet d’apprentissage est supprimé, toutes les données de rapport associées sont également supprimées.
...
Lorsque les utilisateurs cliquent sur **[!UICONTROL Se déconnecter]** dans Learning Manager, ils sont à présent déconnectés de l&#39;application Learning Manager et de leur Adobe ID.
...
* Dans le rôle d’administrateur, les cours retirés ne sont pas affichés pas dans la liste des cours si les catalogues sont créés par le biais de la boîte de dialogue **Ajouter des objets d’apprentissage**.

**Autres corrections**

* Dans le rôle d’administrateur, le nom complet des élèves est affiché dans l’onglet **Élèves**. Auparavant, seul le prénom de l’élève s’affichait.
...
* Dans le rôle d&#39;administrateur, quand un utilisateur saisit le nombre d&#39;élèves et clique sur **Passer une commande**, une boîte de dialogue contenant le détail des frais d&#39;adhésion mensuels et annuels par utilisateur s&#39;affiche.
...
* L&#39;application Learning Manager prend en charge le chargement de contenu SCORM même si la version n&#39;est pas mentionnée dans le fichier manifest.xml. Par défaut, la version est considérée comme étant 1.2.
