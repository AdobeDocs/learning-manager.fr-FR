...
## Configuration requise pour Live Hub

Avant de rejoindre ou d’héberger une session Live Hub, assurez-vous que la configuration de votre appareil, navigateur, réseau, audio et vidéo est conforme à la configuration système minimale requise pour une expérience optimale.

Live Hub dispose de son propre ensemble de navigateurs pris en charge, de systèmes d&#39;exploitation, de configurations réseau requises et de recommandations matérielles. Consultez [Configuration requise pour Live Hub](../migrated/getting-started-with-live-hub/system-requirements-for-live-hub.md) pour plus d&#39;informations.
