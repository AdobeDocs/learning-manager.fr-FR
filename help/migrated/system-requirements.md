...
Résolution minimale prise en charge : 1 024 x 720.
...
## Spécifications du navigateur

La page d’accueil de la disposition immersive n’est pas prise en charge sur les navigateurs IE 11.
...
* Bannière pour réseaux sociaux : 1 600 x 240 px
...
Un microphone est requis pour l’enregistrement audio ; une webcam est requise pour l’enregistrement vidéo.
...
La taille maximale de fichier pouvant être téléchargé est de 600 Mo.

>[!NOTE]
>
>Si la taille du *user.csv* Le fichier dépasse 100 Mo. L’importation de ce fichier peut entraîner un comportement inattendu du navigateur. Le problème se produit car le navigateur manque de mémoire.
...
### Chargement de module {#moduleupload}
...
<table>
 <tbody>
  ...
  <tr>
   <td>
    <p><strong>Logo de la société</strong></p></td>
   <td>
    <p>« png », « jpg », « jpeg », « bmp », « gif »</p></td>
  </tr>
  <tr>
   <td>
    <p><strong>Chargement des certifications</strong></p></td>
   <td>
...
## Spécification de hauteur et de largeur pour le téléchargement d’éléments {#heightandwidthspecificationforuploadingelements}
...
<table>
 <tbody>
  ...
  <tr>
   <td>
    <p>Badge sur le panneau Réalisations de l’élève</p></td>
   <td>
    <p>40x40 pixels</p></td>
  </tr>
  <tr>
   <td>
    <p>Badge développé dans l’application de l’élève</p></td>
   <td>
    <p>90x90 pixels</p></td>
  </tr>
  <tr>
   <td>
    <p>Image de profil utilisateur sur les réalisations de l’élève</p></td>
   <td>
    <p>100x100 pixels</p></td>
  </tr>
  <tr>
   <td>
    <p>Photo de profil utilisateur du menu déroulant Se déconnecter</p></td>
   <td>
    <p>42x42 pixels</p></td>
  </tr>
  <tr>
   <td>
    <p>Logo de la société sur l’en-tête</p></td>
   <td>
...
## Configuration réseau requise {#networkrequirements}

Assurez-vous que les domaines tiers suivants figurent sur la liste blanche si vous êtes sur un réseau soumis à des restrictions.
...
### Cas spécifiques étendus {#specificextendedcases}
...
<table>
 <tbody>
  ...
  <tr>
   ...
   <td>Zones Box situées à Francfort</td>
  </tr>
  <tr>
