...
description: Adobe Learning Manager propose une suite complète d’API REST qui aide les clients à créer des applications qui s’intègrent à Learning Manager, voire des expériences utilisateur personnalisées et des extensions aux workflows qui aident leur entreprise.
