...
Pour plus d’informations, voir [Application Adobe Learning Manager pour Microsoft Teams](/help/migrated/adobe-learning-manager-app-microsoft-teams.md).
...
* La page Compétences comporte une nouvelle colonne, Instructeurs. La colonne affiche le nombre d’instructeurs par rapport à la compétence. Si vous cliquez sur le numéro dans la colonne Instructeurs, vous serez redirigé vers une fenêtre contextuelle qui indique le nombre d’instructeurs affectés à une compétence.
...
Téléchargez l’application mobile depuis le Google Play Store ou l’Apple App Store. Les utilisateurs de l’ancienne version de l’application seront invités à télécharger et à installer la nouvelle application.
...
* Options de recherche vous permettant de spécifier des paramètres de recherche, tels que des métadonnées de cours, des balises et des compétences, pour définir l’étendue de la recherche.
...
Lorsque l’élève clique sur le lien ou sur le bouton Accéder au catalogue, il est redirigé vers la page du catalogue du cours. L’élève voit ensuite la liste des groupes d’utilisateurs à filtrer en fonction des groupes d’utilisateurs dans le catalogue et sur la page Mon apprentissage.
...
La page Présentation affiche une fenêtre contextuelle d&#39;inscription lorsqu&#39;un élève est confronté à un conflit de sessions. En cas d’inscription à partir de la page du catalogue ou de la page de présentation et si un élève a déjà des conflits de sessions, une fenêtre contextuelle de conflit contenant les détails des sessions en conflit s’affiche. Même si un élève a une session en conflit, il peut s’inscrire à la nouvelle session.
...
Pour plus d’informations, voir [Rapport sur l’utilisation de l’instructeur](/help/migrated/administrators/feature-summary/reports.md#instructor-utilization-report).
...
* Escalade au N+2 pour échéance de cours manquée
...
| Rechercher et filtrer des villes | filter.cityName=city_name<br>Prend également en charge une liste de villes séparées par des virgules | GET /primeapi/v2/search |
...
### Filtrage des groupes d&#39;utilisateurs
