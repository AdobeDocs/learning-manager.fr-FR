---
user-guide-title: Guide d’Adobe Learning Manager
...
* [Guide de l’utilisateur de Learning Manager](user-guide.md)
* Introduction {#introduction}
   ...
   * [Adobe de l’application Learning Manager pour les Microsofts Teams](adobe-learning-manager-app-microsoft-teams.md)
   ...
   * [Recommendations dans Adobe Learning Manager](recommendations-adobe-learning-manager.md)
   * [Transition à partir du gestionnaire FTP d’Adobe](transition-from-ftp-manager.md)
...
* Administrateur {#admin}
   ...
   * [Ajout d’utilisateurs et création de groupes d’utilisateurs](administrators/feature-summary/add-users-user-groups.md)
   * [Ajouter des emplacements de salle de classe](administrators/feature-summary/classroom.md)
   * [Création de modules de cours, d’instances et de programmes d’apprentissage](administrators/feature-summary/courses.md)
   ...
   * [Gestion des commandes et de la facturation Learning Manager](administrators/feature-summary/billing-management.md)
   ...
   * [Ajout d’utilisateurs par lot](administrators/add-users-in-bulk.md)
   ...
   * [Création et modification de compétences et de niveaux](administrators/feature-summary/skills-levels.md)
   ...
   * [Personnaliser la page d’accueil des élèves](administrators/feature-summary/customize-learner-homepage.md)
   ...
   * [Annonce](administrators/feature-summary/announcements.md)
   ...
   * [xAPI dans Learning Manager](authors/feature-summary/xapi.md)
   ...
   * [Activer le contrôle total du catalogue partagé](administrators/feature-summary/shared-catalog-full-control.md)
   * [Mapper une compétence avec des domaines de compétence](administrators/feature-summary/curation-skills.md)
...
* Administrateur de l’intégration {#integration}
   ...
   * [Installer le connecteur de Microsofts Teams](integration-admin/feature-summary/install-microsoft-teams-connector.md)
   ...
   * [Gestion des rôles personnalisés via des fichiers CSV](integration-admin/feature-summary/configure-role-csv-files.md)
* Auteurs {#authors}
   ...
   * [Ajout d’objets d’apprentissage dans différentes langues](authors/feature-summary/add-new-language-learning-objects.md)
   * [Notifications utilisateur](authors/feature-summary/user-notifications.md)
   * [Modèles de courrier électronique](authors/feature-summary/email-templates-author.md)
...
* Élève {#learner}
   ...
   * [Paramètres du profil](learners/feature-summary/settings.md)
   ...
   * [Annonce](learners/feature-summary/announcements.md)
   ...
   * [Application des élèves pour appareils mobiles et tablettes](learners/feature-summary/ipad-android-tablet-users.md)
...
* Responsable {#manager}
   ...
   * [Tableau de bord du responsable](managers/feature-summary/manager-dashboard.md)
   * [Rapports](managers/feature-summary/reports.md)
   * [Objets d’apprentissage](managers/feature-summary/learning-objects.md)
   * [Notifications utilisateur](managers/feature-summary/user-notifications.md)
...
* Foire aux questions {#faq}
   * [Foire aux questions pour les administrateurs](administrators/frequently-asked-questions-for-administrators.md)
   * [Foire aux questions pour les auteurs](authors/frequently-asked-questions-for-authors.md)
   * [Foire aux questions pour les instructeurs](instructors/frequently-asked-questions-for-instructors.md)
   * [Foire aux questions pour les responsables](managers/frequently-asked-questions-for-managers.md)
* Base de connaissances {#knowledge-base}
   * [Connexion à Learning Manager impossible](kb/unable-log-in-learning-manager.md)
   ...
   * [Résolution des problèmes d’application Learning Manager](kb/troubleshooting-issues-with-adobe-learning-manager-desktop-app.md)
   * [Les utilisateurs sont automatiquement supprimés dans Learning Manager](kb/auto-delete.md)
   * [Problèmes de publication dans le domaine UE](kb/publish-issue-eu-domain.md)
   * [Inscription impossible en tant qu’utilisateur externe](kb/register-issue-external-user.md)
   ...
   * [Le module n’est pas marqué comme terminé après avoir suivi un cours](kb/module-not-marked-complete.md)
