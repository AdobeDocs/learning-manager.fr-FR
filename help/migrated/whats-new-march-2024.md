...
Afficher [Plusieurs marques personnalisées](administrators/feature-summary/themes.md#multiple-branding) pour plus d&#39;informations.
...
Si un grand nombre d&#39;élèves sont inscrits au cours, par exemple, plus de 50 000, la liste des élèves ne s&#39;affiche pas. Vous pouvez rechercher un élève dans la barre de recherche *Rechercher des élèves* ou sélectionner le lien **Télécharger** en haut de la barre de recherche pour télécharger la liste des élèves.

### Page Administrateur - Élèves

Lorsque vous recherchez un utilisateur, les options **Télécharger l&#39;élève** et **Exporter** téléchargent le même rapport. En attendant, lors de la recherche d’un groupe d’utilisateurs, vous pouvez désormais télécharger des utilisateurs filtrés à partir de ce groupe d’utilisateurs. Lors de la recherche d’un groupe d’utilisateurs,
la **liste Télécharger l&#39;élève** se transforme en **liste Télécharger l&#39;élève pour le groupe d&#39;utilisateurs** L&#39;option **Exporter** télécharge à nouveau la liste complète.
...
Pour les utilisateurs externes, le même comportement s’applique. Si le nombre d&#39;utilisateurs est élevé, vous pouvez télécharger les utilisateurs et récupérer les détails d&#39;un utilisateur après une recherche au format *Nom, e-mail | UUID*.

#### Page Nettoyage de l’utilisateur

Sur la page Nettoyage de l&#39;utilisateur, pour les utilisateurs supprimés, nous avons supprimé la fonctionnalité de tri le **Date de suppression**. Vous ne pouvez trier que sur les UUID.
...
Dans cette version de Adobe Learning Manager, si le nombre d&#39;utilisateurs inscrits est important, la liste déroulante **État** affiche uniquement deux options : **Inscrit** et **Désinscrit**. L&#39;option **Inscrit** est sélectionnée par défaut. Si vous sélectionnez **Désinscrit**, la liste des élèves désinscrits s&#39;affiche.

#### Modifications apportées au groupe d’utilisateurs

Dans le cas d&#39;un groupe d&#39;utilisateurs, si le nombre d&#39;utilisateurs dans le groupe d&#39;utilisateurs est inférieur à, par exemple, 50 000, le menu déroulant **État** affiche toutes les options : Certifié, Attribué et Expiration.

Si le nombre d&#39;utilisateurs dans un groupe d&#39;utilisateurs est important, la liste déroulante **État** affiche uniquement deux options : **Inscrit** et **Désinscrit**, selon la nouvelle conception.
...
Lorsque vous recherchez un utilisateur, les options **Télécharger l&#39;élève** et **Exporter** téléchargent le même rapport. En attendant, lors de la recherche d’un groupe d’utilisateurs, vous pouvez désormais télécharger des utilisateurs filtrés à partir de ce groupe d’utilisateurs. Lors de la recherche d&#39;un groupe d&#39;utilisateurs, l&#39;option **Télécharger la liste des élèves** se transforme en **Télécharger la liste des élèves pour le groupe d&#39;utilisateurs**. L&#39;option **Exporter** télécharge à nouveau la liste complète.
...
En fonction des [paramètres de l&#39;administrateur](administrators/feature-summary/classroom.md#classroom-settings), vous pouvez [créer, modifier et supprimer des emplacements](administrators/feature-summary/classroom.md#add-classroom-location) en tant qu&#39;auteur.
...
En tant qu’administrateur, vous pouvez appliquer des restrictions à un auteur pour modifier ou supprimer un emplacement de salle de classe. Afficher les [paramètres de salle de classe](administrators/feature-summary/classroom.md#classroom-settings) pour plus d&#39;informations.
...
Voir [Plans d&#39;apprentissage](administrators/feature-summary/learning-plans.md) pour plus d&#39;informations.
...
Voir [État de la soumission](instructors/feature-summary/learners.md#filter-file-submissions) pour plus d&#39;informations.
...
Lors de la création d&#39;une liste de contrôle, un auteur peut sélectionner **Activer** dans la section Liste de contrôle obligatoire. Cela empêche un élève de continuer dans le module s’il échoue à la liste de contrôle. Ils ne peuvent poursuivre que s&#39;ils réussissent la liste de vérification.
...
Afficher [Créer une liste de contrôle](authors/feature-summary/courses.md#checklist-fail) pour plus d&#39;informations.
...
Nous avons ajouté les colonnes *Instance* et *Élève* au vocabulaire terminologique du produit.
...
Dans les versions actuelles de Adobe Learning Manager, un élève est marqué comme **Non présent** lorsqu&#39;il est inscrit à une session Connect VC, mais il ne répond pas aux critères d&#39;achèvement.
...
Afficher l&#39;étiquetage blanc dans l&#39;[application mobile Adobe Learning Manager](white-label.md) pour plus d&#39;informations.
...
Si vous effectuez une migration pour mettre à jour un cours, un plan d’apprentissage ou une certification existant, le cours, le plan d’apprentissage ou la certification avec la **lettre d’intention unique** est ajouté à l’application d’auteur.

Lors de la migration, vous devez mettre à jour les valeurs **uniqueLOId** dans les fichiers CSV pour le cours, le plan d’apprentissage ou la certification, même s’il s’agit d’une colonne facultative.

Si la colonne **uniqueLoId** n&#39;est pas ajoutée avant d&#39;effectuer la migration lors de la mise à jour du cours, du plan d&#39;apprentissage ou de la certification existants ayant **uniqueLOId**, après la migration, les valeurs **uniqueLOId** seront remplacées par des valeurs NULL.
...
Téléchargez les fichiers CSV à partir du [manuel de migration](integration-admin/feature-summary/migration-manual.md#csv-specifications-and-sample-csvs).
...
Si vous tentez de télécharger le rapport **Accès de connexion** qui va au-delà de cinq trimestres, un message d&#39;erreur s&#39;affiche. Un message d&#39;erreur similaire s&#39;affiche si vous tentez de télécharger le rapport **Audit de l&#39;utilisateur** qui va au-delà de six mois.

### API obsolètes

Consultez [Dépréciations d’API dans Adobe Learning Manager](api-deprecations-list.md) pour obtenir la liste cumulée de toutes les API déconseillées dans le produit.
...
* Le bouton **Se désinscrire** ne s&#39;affiche pas comme prévu après la première inscription, mais il s&#39;affiche après une actualisation.
...
* Dans l&#39;application mobile ou en mode immersif, après avoir supprimé ou retiré une instance de cours et sélectionné l&#39;instance active suivante, le bouton **Enregistrer vos intérêts** s&#39;affiche au lieu de **S&#39;inscrire**.
...
Voir [Configuration requise pour Adobe Learning Manager](system-requirements.md).
