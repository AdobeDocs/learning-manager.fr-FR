...
* **Recherche intelligente** : comprend le contexte et l&#39;intention derrière les termes de recherche
* **Pertinence améliorée** : fournit des résultats en fonction de la signification de votre requête
* **Expérience utilisateur améliorée** : aide les élèves à utiliser le bon contenu
...
* **Expérience utilisateur** : améliore la satisfaction des utilisateurs en permettant une récupération rapide des informations
* **Efficacité** : permet de gagner du temps en réduisant les efforts pour localiser un contenu spécifique.
...
Adobe Learning Manager offre une expérience de recherche plus intelligente et plus avancée. Non seulement il correspond aux mots-clés, mais il comprend également la signification contextuelle des requêtes des utilisateurs pour trouver les résultats les plus pertinents.
...
Adobe Learning Manager propose des fonctionnalités de recherche améliorées qui permettent aux utilisateurs d’effectuer des recherches dans le contenu réel de divers types de fichiers, notamment des vidéos, des fichiers audio, des PDF, des documents, des présentations et des feuilles de calcul. Le système transcrit automatiquement ce contenu pour fournir des résultats de recherche plus complets et plus précis. En outre, les enregistrements des réunions Adobe Connect sont intégrés dans la recherche, ce qui permet de s’assurer que des informations précieuses ne sont pas perdues. Si une correspondance est trouvée dans le contenu, le modèle de recherche augmente le classement de ce contenu dans les résultats finaux. Le classement final est déterminé par plusieurs facteurs, comme indiqué dans la section [Recherche et reclassement](/help/migrated/learners/feature-summary/advanced-search.md#ai-powered-search-and-re-ranking) optimisés par l&#39;IA.
...
La recherche de Adobe Learning Manager mène le secteur en associant des technologies traditionnelles et avancées. Il combine des méthodes de recherche traditionnelles telles que la correspondance exacte et la recherche sémantique sophistiquée pour produire des résultats complets. Le système classe ces résultats en fonction de facteurs clés tels que le nombre d’inscriptions, les dates de publication, les notations et la popularité. Cela garantit des correspondances de haute qualité à partir de tous les indices, guidées par notre système de classement de la qualité des cours.

Dans l&#39;ensemble, la recherche basée sur l&#39;IA est conçue pour être approfondie, précise et conviviale, afin d&#39;aider les élèves à trouver rapidement les ressources dont ils ont besoin pour soutenir leur parcours d&#39;apprentissage.
