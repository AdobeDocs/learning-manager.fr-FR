...
## Création d’une instance {#createaninstance}
...
1. En mode Administrateur, cliquez sur **[!UICONTROL Cours]** dans le volet de gauche. Cette page affiche tous les cours créés par tous les auteurs dans votre compte Learning Manager.
...
1. Dans les options du catalogue que vous venez de créer, vous pouvez sélectionner différents types d’apprentissage à ajouter, par exemple, un programme d’apprentissage, une certification ou un cours.
