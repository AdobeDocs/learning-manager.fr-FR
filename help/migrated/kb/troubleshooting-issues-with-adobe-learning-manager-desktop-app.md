...
1. Supprimez toute installation antérieure de l’application de bureau Adobe Learning Manager. Pour plus d’informations, voir  [Comment nettoyer les installations précédentes](#howtocleanuppreviousinstallationsofadobelearningmanagerdesktopapp) pour plus d’informations.
1. Pour les erreurs survenant lors du processus d’installation, voir [Comment trouver les journaux d’application](#howtofindapplicationlogs). Contactez votre administrateur de l’application de bureau Adobe Learning Manager pour obtenir plus d’aide.
...
1. Dans Social Learning, cliquez sur **[!UICONTROL Nouvelle publication]** (tout d’abord, si vous ne disposez pas d’un panneau, créez-en un). Cliquez sur l’une des options de bouton de publication ci-dessous qui apparaissent : Capture d’écran, Enregistrement audio, Enregistrement vidéo, Galerie Adobe Learning Manager. Vous êtes redirigé vers une page à partir de laquelle vous pouvez lancer l’application de bureau Adobe Learning Manager.
...
## Comment supprimer le dossier temporaire de l’application de bureau Adobe Learning Manager ? {#howtocleanupadobecaptivateprimefordesktoptempfolder}
