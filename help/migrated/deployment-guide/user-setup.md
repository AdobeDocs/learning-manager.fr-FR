---
description: Classez les utilisateurs comme internes et externes. Les utilisateurs internes sont les utilisateurs d’une organisation ou d’un groupe spécifique.
jcr-language: en_us
