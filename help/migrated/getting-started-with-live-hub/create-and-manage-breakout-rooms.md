...
1. Sélectionnez ![icône de rupture](./assets/breakout-icon.svg) dans la barre de contrôle.

   ![Sélectionner le panneau Sessions en petits groupes](assets/select-breakout-sessions-panel.png)
...
1. Sélectionnez ![icône de rupture](./assets/breakout-icon.svg) dans la barre de contrôle. <br> Le panneau Répartitions s’ouvre.

   ![Ouvrir le panneau Sous-groupes](assets/open-breakouts-panel.png)
...
1. Sélectionnez **Enregistrer**. <br> La session en petits groupes apparaît dans le panneau **Groupes** avec une balise **Nouveau**.
...
1. Sélectionnez **Démarrer les sous-groupes**. <br> Une notification affiche **À partir de 5 secondes**, et les élèves sont ensuite déplacés vers les salles d’atelier qui leur sont attribuées avec la configuration configurée appliquée.

   ![Démarrer la session en petits groupes](assets/start-breakout-session.png)
...
1. Sélectionnez l’icône de modification (crayon) sur la session.
   ...
   ![Modifier l’icône de session de découpage](assets/edit-breakout-session-icon.png)
...
1. Sélectionnez les autres options (**...**) sur la session.
   ...
   ![Menu De Session En Atelier En Double](assets/duplicate-breakout-session-menu.png)
...
1. Sélectionnez **Supprimer**. <br> Une fenêtre contextuelle de confirmation s’affiche.

   ![Confirmation de suppression d&#39;éclatement](assets/delete-breakout-confirmation.png)
...
1. Sélectionnez **Vérifier la salle**. <br> Une fenêtre contextuelle **Vérifier la salle** s&#39;affiche avec le résumé de la salle.

   ![Résumé de l’IA en salle de réunion](assets/breakout-room-ai-summary.png)
...
![Panneau de conversation de la salle d&#39;atelier](assets/breakout-room-chat-panel.png "Interface de la session d&#39;atelier montrant le panneau de conversation de la salle d&#39;atelier.")
...
1. Sélectionnez **Terminer les sous-groupes** dans la session de sous-groupes active. <br> Tous les élèves sont replacés dans la salle principale et la session de petits groupes se termine pour tous les participants.

   ![Terminer la session en petits groupes](assets/end-breakout-session.png)
