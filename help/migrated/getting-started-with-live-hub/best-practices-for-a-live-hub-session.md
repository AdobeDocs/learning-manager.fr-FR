---
title: Bonnes pratiques pour une session Live Hub
...
* **Attribution automatique** : répartit automatiquement les participants entre les salles de réunion.
...
* **Tout le monde** : à utiliser pour les discussions ouvertes et les conversations de groupe.

* **Questions** : à utiliser pour collecter des questions des élèves et y répondre.

* **Privé** : à utiliser pour une communication un-à-un sans perturber la session.
...
* **Questionnaires** pour évaluer la compréhension de l&#39;élève après l&#39;enseignement d&#39;un concept.

* **Sondages** pour recueillir des opinions, recueillir des commentaires ou orienter les décisions de groupe.
...
| **Niveau d&#39;engagement** | **Indicateur** | **Action recommandée** |
|----|----|----|
| **Élevé** | Vert | Poursuivre l&#39;activité en cours. Pensez à introduire une activité de discussion, de quiz ou de groupe pour renforcer la participation des élèves. |
| **Moyenne** | Jaune | Réengagez les élèves en posant des questions, en lançant un sondage ou en encourageant la participation par chat. |
| **Faible** | Rouge | Modifiez le format de l&#39;activité. Envisagez d&#39;utiliser un sondage, une activité en atelier, une invite de discussion ou un ajustement de rythme pour regagner l&#39;attention de l&#39;élève. |
...
| **Zone d&#39;analyse** | **Description** |
|----|----|
| **Résumé de la session** | Vérifiez la présence, la durée de la session, la disponibilité des enregistrements et les détails généraux de la session. |
| **Interactions** | Évaluer la participation des élèves aux sondages, aux questionnaires, aux salles de réunion, aux questions-réponses, aux réactions et à d&#39;autres activités interactives. |
| **Activité des participants** | Identifiez les niveaux d&#39;engagement de chaque élève et déterminez si un soutien supplémentaire peut être nécessaire. |
| **Rapports** | Téléchargez des rapports de session et d’interaction pour la tenue de documents, l’analyse ou le partage avec les parties prenantes. |
