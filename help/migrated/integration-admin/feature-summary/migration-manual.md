...
Une nouvelle API de migration, `runStatus`, permet aux administrateurs d&#39;intégration de suivre la progression des exécutions de migration déclenchées via l&#39;API.
