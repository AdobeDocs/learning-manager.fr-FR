...
![Rapport d’utilisateur montrant les colonnes internes ID utilisateur et e-mail du responsable surlignées en jaune](/help/migrated/assets/user-report-columns.png)
_Rapports utilisateur mettant en évidence les ID utilisateur internes et les adresses e-mail du responsable pour rationaliser la gestion des utilisateurs_
