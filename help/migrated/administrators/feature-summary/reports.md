...
Consultez un rapport récapitulatif de toutes les activités d’apprentissage de la plate-forme. Sur cette page, vous pouvez voir les informations récapitulatives suivantes pour l’équipe et les profils externes de l’utilisateur racine sélectionné. Vous pouvez également sélectionner une plage temporelle :
...
Si un profil externe possède un responsable, la hiérarchie du responsable s’affiche dans la liste déroulante **[!UICONTROL Données indiquées pour]**. L’utilisateur sera répertorié dans la hiérarchie du responsable dans toutes les pages de détails (Résumé de l’apprentissage, Conformité et État des compétences)

Si ce n’est pas le cas, tous les détails des utilisateurs individuels s’affichent dans la liste.de

Pour obtenir plus de détails sur les inscriptions des différentes équipes internes, cliquez sur **[!UICONTROL Détails du résumé de l’apprentissage]**.
...
Un tableau de bord est une série de rapports. Les rapports peuvent être groupés dans un tableau de bord selon votre choix. Cliquez sur cet onglet de tableau pour afficher tous les tableaux que vous avez créés. Depuis la liste déroulante **[!UICONTROL Afficher le tableau de bord]**, vous pouvez choisir le tableau par défaut ou un tableau de bord que vous avez créé.
...
Adobe Learning Manager permet aux administrateurs d’une organisation de générer des récapitulatifs liés aux stagiaires.
...
Utilisez le générateur de rapport **[!UICONTROL Piste d’audit de contenu]** pour générer un rapport de toutes les modifications apportées à un cours pendant son existence dans le système. Le rapport généré récupère les informations suivantes.
...
1. Sélectionnez **[!UICONTROL Rapport > Rapport Excel > Piste utilisateur]**. La boîte de dialogue Piste d’audit d’utilisateur s’affiche.
...
Pour ajouter des rapports à votre tableau, cliquez sur le menu déroulant dans l’angle supérieur droit de la fenêtre de votre tableau et cliquez sur **[!UICONTROL Ajouter un rapport]**. Le rapport créé selon cette procédure est associé à votre tableau de bord.
...
* En saisissant des utilisateurs dans le champ **[!UICONTROL Partager avec]**, avec lesquels le tableau de bord est partagé.
...
1. Cliquez sur le lien **[!UICONTROL Affichage des rapports sur les cours]** dans l’onglet Mes tableaux de bord de la page Rapports.\
...
**[!UICONTROL Déplacer vers un tableau de bord]** Vous pouvez déplacer le rapport en cours vers un autre tableau de bord, choisi dans la liste des tableaux de bord.

**[!UICONTROL Créer une copie]** Vous pouvez copier le rapport dans le même tableau de bord ou dans un autre, choisi dans la liste des tableaux de bord.
...
**[!UICONTROL Redimensionner]** Vous pouvez redimensionner vos rapports aux formats 1 × 1 (moyen) et 2 × 2 (grand).
