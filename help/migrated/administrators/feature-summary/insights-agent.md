...
Insights Agent est une fonctionnalité optimisée par l’IA dans Adobe Learning Manager qui permet aux administrateurs d’interroger des données d’apprentissage en utilisant un langage naturel. Au lieu de télécharger des rapports et de manipuler des feuilles de calcul, vous tapez une question telle que « Combien de cours ont été créés au cours des 3 derniers mois dans le compte ? Donnez-moi un rapport mensuel. », et Insights Agent récupère et présente les données directement. Vous pouvez afficher les résultats sous forme de texte, de puces ou de tableaux, ou les télécharger sous forme de fichier CSV.
...
- Analyser les tendances d’inscription dans les cours ou les parcours d’apprentissage
- Afficher les données de progression pour un cours ou un parcours d’apprentissage spécifique

Chaque requête renvoie une table formatée ou un fichier CSV téléchargeable, ainsi qu’une explication en langage clair de la façon dont les résultats ont été calculés.
...
3. **Résultats** : l&#39;agent présente vos données sous forme de texte, de puces ou de tableau, selon la nature des résultats. Un résumé en langage clair est inclus avec les résultats. Lorsque les résultats contiennent 50 lignes ou moins, le résumé inclut des informations analytiques sur les données. Lorsque les résultats contiennent plus de 50 lignes, le résumé fournit des statistiques au niveau des colonnes.
...
Utilisez Insights Agent dans Adobe Learning Manager pour interroger des données d’apprentissage à l’aide de questions en langage clair et obtenir des résultats sous forme de texte, de tableaux ou de fichiers CSV téléchargeables.
...
3. Sélectionnez **Envoyer** ou appuyez sur **Entrée** pour soumettre votre question.
...
>[!TIP]
>
>Si vous souhaitez explorer les données associées, lancez une nouvelle requête qui incorpore ce que vous avez appris de la première. Par exemple, après avoir visualisé les totaux d&#39;inscription par région, lancez une nouvelle requête pour approfondir les régions sous-performantes.
...
La qualité de votre requête affecte directement la qualité des résultats renvoyés par Insights Agent. Une requête correctement formée comprend trois ingrédients : le contexte, par exemple, le contenu et les élèves, la portée, par exemple, le statut, la plage horaire et l’état de l’utilisateur, ainsi que des colonnes, par exemple, les champs exacts que vous souhaitez dans la sortie. Apprenez à utiliser la terminologie, la structure de requête et les exemples de requêtes appropriés comme points de départ.
...
L&#39;absence de l&#39;un de ces composants peut conduire à des résultats ambigus ou à une question de clarification de la part de l&#39;agent.
...
La fourniture d&#39;une ancre de contenu permet à l&#39;agent de savoir quels éléments d&#39;apprentissage examiner. Vous pouvez effectuer l’une des opérations suivantes pour l’ancrer :
...
Si une requête est liée à un élève, utilisez l’une des méthodes suivantes :
...
L’omission de détails sur le champ d’application peut conduire à des résultats plus larges que prévu.
...
| « Montre-moi qui a échoué » | « Afficher le nom, l’adresse e-mail, le nom du cours et l’état d’achèvement des élèves qui ont échoué » |
...
- « Afficher le taux d’achèvement par groupe d’utilisateurs pour tous les cours de conformité. Inclure le nom du groupe d’utilisateurs, le nombre total d’inscrits, le nombre total de terminés et le pourcentage d’achèvement. »
...
- « Afficher le taux d&#39;achèvement de toutes les certifications étiquetées de type de conformité, regroupées par service. Inclure le nom du service, le nombre total d’inscrits et le % d’achèvement. »
