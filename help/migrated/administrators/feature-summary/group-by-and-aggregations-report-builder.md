...
Par exemple, si vous regroupez par **Nom de l&#39;instructeur**, vous ne pouvez pas afficher les valeurs individuelles de **Nom de la session** à côté. À la place, vous appliqueriez **Count** au champ ID de session pour afficher le nombre de sessions enseignées par chaque instructeur.
...
2. Saisissez le nom et la description du rapport :
   ...
   * **Nom :** comparez la progression de l&#39;inscription entre les utilisateurs
   * **Description :** ce rapport regroupe les élèves par responsable et calcule des mesures récapitulatives telles que le nombre total d&#39;élèves, la progression moyenne et le nombre d&#39;achèvements pour l&#39;état d&#39;inscription=COMPLETED
...
1. Sélectionnez **Nombre distinct** pour Nom-utilisateur.
...
1. Appliquez un filtre où Inscription - Statut est égal à Terminé.
2. Appliquez un deuxième filtre dans lequel Utilisateur - Nom du responsable n’est pas vide.
...
Sélectionnez **Enregistrer le rapport** et sélectionnez **Actions** > **Télécharger** pour télécharger le rapport. Vous recevrez une notification pour télécharger le rapport (CSV) une fois qu’il sera prêt.
