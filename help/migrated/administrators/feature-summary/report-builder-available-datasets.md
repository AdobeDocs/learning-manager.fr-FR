...
Les informations figurant dans le tableau ne sont pas exhaustives. Consultez la section **Liste des colonnes dans les jeux de données** pour obtenir la liste complète de toutes les colonnes dans les jeux de données.

| **Jeu De Données** | **Ce qu&#39;il contient** | **Champs clés** |
|----------------------------------------------------------|--------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Utilisateur** | Données de profil d’élève pour les élèves actifs et supprimés | Nom, adresse e-mail, ID utilisateur, responsable, champs actifs, état |
| **Transcription (objet d’apprentissage) et Transcription (module)** | Enregistrements d’inscription et d’achèvement | Date d’inscription, Date d’achèvement, Pourcentage d’avancement, Statut |
| **Objet d&#39;apprentissage** | Métadonnées de cours, de parcours d’apprentissage et de certification | Nom de l&#39;objet d&#39;apprentissage, ID de l&#39;objet d&#39;apprentissage, type, catalogue, étiquette du catalogue, état |
| **Instance d&#39;objet d&#39;apprentissage** | Détails au niveau de l’instance pour les cours avec plusieurs instances | Nom de l’instance, ID de l’instance, limite d’inscription, échéance |
| **Catalogue** | Paires clé-valeur des métadonnées de catalogue et du libellé de catalogue | Noms des auteurs, Date de création, Durée, Format. **Les colonnes de libellé de catalogue sont configurées par le client**. Ils apparaissent uniquement si des étiquettes de catalogue sont configurées pour votre compte. Les noms et valeurs d&#39;étiquette qui s&#39;affichent reflètent votre propre configuration. |
| **Groupe d’utilisateurs** | Appartenance à un groupe d’utilisateurs et hiérarchie | Date de création, nombre de membres, nom, état |
| **Module** | Détails de la session pour la classe, la classe virtuelle et les modules d’apprentissage en ligne | ID du module, nom de l’instructeur, heure de début, heure de fin, lieu |


>[!NOTE]
>
>Pour les cours acquis à partir d&#39;un autre compte via le partage de catalogue, la colonne **Noms d&#39;auteurs** dans le jeu de données d&#39;objet d&#39;apprentissage renvoie le nom d&#39;auteur d&#39;origine à partir du compte source. Cela diffère de l’interface d’administration ALM standard et des rapports fixes, où les cours acquis affichent « Auteur externe » à la place. Ce comportement est spécifique au Report Builder et s’applique uniquement aux comptes de pairs (de réception).
...
>[!NOTE]
>
>Si un rapport généré contient des données de cours mais pas des données de parcours d’apprentissage, vérifiez si vous avez joint le jeu de données d’objet d’apprentissage au jeu de données de module. Les modules sont directement liés aux cours, mais pas directement aux parcours d’apprentissage. Par conséquent, lorsque les champs du module sont inclus, Report Builder peut renvoyer uniquement les enregistrements de cours et filtrer les parcours d’apprentissage. Pour générer des rapports sur les parcours d’apprentissage, évitez d’ajouter des champs de module, sauf si le rapport est spécifiquement destiné à analyser les données de module au niveau du cours.
...
* **Inscription** (ensemble de données d&#39;inscription), la table de faits principale. Il se connecte directement à l&#39;**utilisateur** (l&#39;élève qui s&#39;est inscrit), à l&#39;**objet d&#39;apprentissage** (ce à quoi il s&#39;est inscrit) et, par l&#39;intermédiaire de l&#39;objet d&#39;apprentissage, à **module**, à **catalogue**, à **étiquette de catalogue** et à **instance d&#39;objet d&#39;apprentissage**.
* **Transcription du module** (ensemble de données moduleTranscript) : table de faits de progression au niveau du module. Il se connecte à **Utilisateur** et à **Module**, qui à son tour renvoie à **Objet d&#39;apprentissage**.
...
* **Instructeur** : le module rejoint l’utilisateur en tant qu’instructeur de la session
* **Auteur** : l&#39;auteur de l&#39;objet d&#39;apprentissage rejoint l&#39;utilisateur en tant qu&#39;auteur de l&#39;objet d&#39;apprentissage
...
### Types de jeux de données de groupe d&#39;utilisateurs
...
| **Ensemble de données** | **Type de groupe** |
|---------------------------------------------------------|---------------------------------------------------------------|
| **Groupe d’utilisateurs** (userGroup) | Tous les groupes d’utilisateurs. Utilisez-le comme ensemble de données du groupe d’utilisateurs principal |
| **Groupe d’utilisateurs (champ actif)** (groupe_utilisateur_champ_actif) | Groupes basés sur les valeurs des champs actifs (par exemple, région, service) |
| **Groupe d’utilisateurs (équipe)** (groupe_utilisateur_équipe) | Groupes basés sur la hiérarchie du responsable |
| **Groupe d&#39;utilisateurs (personnalisé)** (custom_user_group) | Groupes personnalisés configurés manuellement |
| **Groupe d’utilisateurs (intégré)** (inbuilt_user_group) | Groupes définis par le système |
...
| **Champ dérivé** | **Ce qu&#39;il calcule** | **Ensembles de données requis** |
|-------------------------|-------------------------------------------------------------------------|-----------------------------------------|
| **Conformité %** | Pourcentage d’élèves requis ayant terminé des cours marqués comme étant conformes | Groupe d’utilisateurs, Objet d’apprentissage, Transcription |
| **Achèvement %** | Déclarations d&#39;achèvement divisées par inscriptions x 100 | Transcription ou objet d’apprentissage |
| **Nombre d&#39;utilisateurs inscrits** | Nombre total d’élèves inscrits pour un objet d’apprentissage | Objet d’apprentissage |
| **Nombre d&#39;achèvements** | Nombre total d’achèvements pour un objet d’apprentissage | Objet d’apprentissage |
| **Démarrer le comptage** | Élèves ayant commencé mais pas terminé | Objet d’apprentissage |
| **Nombre de membres** | Nombre d’utilisateurs dans un groupe d’utilisateurs | Groupe d’utilisateurs |
