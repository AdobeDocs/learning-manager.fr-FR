...
2. Sélectionnez **Actions** > **Dupliquer**. Une copie du rapport s’ouvre en mode d’édition avec le nom « \[nom du rapport d’origine\]-Copy ». Par exemple, Vue des performances structurées entre les responsables - Copier
...
Le rapport dupliqué est enregistré dans l’onglet Rapports et est indépendant du rapport d’origine.
