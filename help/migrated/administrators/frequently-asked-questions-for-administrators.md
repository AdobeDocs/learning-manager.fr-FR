---
jcr-language: en_us
title: Foire aux questions pour les administrateurs
...
# Foire aux questions pour les administrateurs
...
<table>
 <tbody>
  <tr>
   ...
   <td>
    <p>Lisez ce document pour découvrir les questions fréquemment posées sur Learning Manager en lien avec le rôle d’administrateur. </p></td>
  </tr>
 </tbody>
</table>
...
Oui, vous pouvez ajouter des utilisateurs en bloc à l’aide de la fonction de chargement CSV. Cliquez sur  [ici](/help/migrated/administrators/add-users-in-bulk.md) pour plus d’informations.

+++

+++J’ai mal saisi l’ID de messagerie lors de la création de la connexion de mes élèves, comment puis-je le corriger ?

Pour résoudre le problème de connexion des utilisateurs, vous devez importer un fichier CSV dans Learning Manager. Un exemple de fichier CSV est joint au bas de cette page pour référence. Étant donné que l’adresse e-mail est considérée comme un identifiant unique pour une personne, elle ne peut pas être modifiée. Procédez comme suit :
...
1. Ajoutez d’autres utilisateurs de votre compte au fichier CSV, y compris vous-même
1. Importer ce fichier dans l’application d’administration Learning Manager->Utilisateurs->Ajouter->Importer un fichier CSV
1. Mappez tous les champs, comme vous y êtes invité dans la boîte de dialogue, aux colonnes CSV correspondantes.
...
Dans la version 1.0 d’Adobe Learning Manager, vous pouvez créer des notifications. Refer  [question sur les notifications](/help/migrated/administrators/feature-summary/user-notifications.md) pour plus d’informations.

+++

+++Comment ajouter des certificats pour les cours ?

Adobe Learning Manager ne fournit pas de certificats pour les cours. Cependant, l&#39;administrateur peut créer des badges pour chaque cours en cliquant sur l&#39;onglet Badges dans le panneau de gauche. Lorsque l&#39;administrateur inscrit des élèves à un cours, il peut également associer un badge à celui-ci.

+++

+++Comment importer des signatures pour les certificats ?

Dans Adobe Learning Manager, il n’existe aucune fonction permettant d’importer des signatures pour la certification ou le badge.
...
1. Cliquez sur Liste d&#39;attente dans le volet gauche de la page de détails du cours. Une liste des élèves en liste d&#39;attente s&#39;affiche sur la page.
1. Sélectionnez les élèves et cliquez sur Allouer des places pour les inscrire directement aux cours, en dépassant la limite de places.
...
1. Sélectionnez les élèves et cliquez sur Enregistrer pour enregistrer l’achèvement du cours.

S’il existe plusieurs modules dans un cours et que l’élève n’a terminé qu’un seul d’entre eux, vous pouvez sélectionner un seul module et cliquer sur Enregistrer pour marquer l’achèvement pour l’élève. Si l’élève a terminé tous les modules d’un cours, vous pouvez cliquer sur l’option Tout sélectionner, puis sur Enregistrer.
...
Vous pouvez ajouter un retour d&#39;informations L3 lorsque vous inscrivez des élèves aux cours. Ajoutez une question de retour d&#39;informations L3 en suivant les étapes ci-dessous :
...
1. Ajoutez le nom du responsable, le nombre de places allouées et cliquez sur la coche pour enregistrer les modifications.

Lors de la création des cours, l’auteur choisit le type de cours nommé par le responsable.

+++

+++Comment puis-je inscrire un élève à un cours particulier ?

Inscrivez des élèves aux cours en suivant les étapes ci-dessous :
...
1. Choisissez le cours pour lequel vous souhaitez ajouter des élèves et placez le curseur de la souris dessus.
...
Pour créer un programme d’apprentissage, procédez comme suit :
...
Cliquez sur la flèche déroulante dans l’angle supérieur droit de chaque rapport pour le modifier ou le modifier. Cliquez sur Enregistrer après avoir terminé les modifications et afficher le rapport modifié.

+++

+++Comment modifier les cours, les programmes d’apprentissage et le profil de l’entreprise ?

Vous pouvez modifier des cours ou des programmes d&#39;apprentissage même après les avoir publiés. Pour plus d’informations, voir  [Cours](/help/migrated/administrators/feature-summary/courses.md) et  [programmes d’apprentissage](/help/migrated/administrators/feature-summary/learning-programs.md) Contenu de l’aide.
...
Cliquez sur Cours dans le volet de gauche après vous être connecté en tant qu&#39;administrateur. Une liste de tous les cours disponibles s’affiche.

Vous pouvez rechercher des cours de deux manières :

1. Cliquez sur l’icône de recherche affichée dans le coin supérieur droit. Un champ de recherche s’affiche. Saisissez le nom du cours ou tout mot-clé associé à vos cours pour localiser vos cours.
...
En fonction de votre choix, vous pouvez afficher la liste filtrée des cours et sélectionner les cours requis.

+++

+++Puis-je modifier les thèmes de l’application ? Comment ?

Oui, vous pouvez modifier les thèmes et l’identité visuelle de l’application Learning Manager selon les besoins de votre organisation. Un ensemble de cinq images représentatives est fourni pour prévisualiser les changements de votre thème de couleur avant de les appliquer à votre application. Parcourez ces images en cliquant sur les symboles &lt; et > situés respectivement sur les côtés gauche et droit des images à prévisualiser.
...
1. Ajouter un nom de badge.
1. Chargez le badge en cliquant sur Charger un badge, puis sur Enregistrer.

+++

+++Comment puis-je configurer des points de ludification pour les cours ?

Vous pouvez configurer des points de ludification pour les élèves en suivant les étapes ci-dessous :

1. Cliquez sur Ludification après vous être connecté en tant qu’administrateur. Une page s’affiche avec une liste de niveaux de bronze, d’argent, d’or et de platine et les points requis pour obtenir correspondant à chaque niveau. Une liste de tâches et les points correspondants sont disponibles.
1. Cliquez sur l’icône Modifier en regard de chaque tâche pour configurer/modifier les points.
...
Vous pouvez créer des rapports en procédant comme suit :
...
Vous pouvez basculer la connexion à votre compte vers d&#39;autres rôles tels que l&#39;élève, le responsable et l&#39;auteur sans vous déconnecter de votre compte.

1. Cliquez sur la flèche déroulante en regard de l’image de profil dans le coin supérieur droit de la page.\
   Un menu contextuel s’affiche.
1. Sélectionnez chaque rôle disponible pour accéder aux comptes de rôle respectifs.

+++

+++Comment inclure des notifications pour les utilisateurs ?

Les responsables, les auteurs et les élèves peuvent voir les notifications en fonction des activités du cours. L’administrateur peut activer/désactiver les notifications pour tous les utilisateurs en suivant les étapes ci-dessous :
...
Adobe Learning Manager vous permet d’inscrire des membres de service externes ou des employés externes de votre organisation à l’application.
...
1. Ajoutez le nom du profil, l’adresse e-mail du responsable, les places allouées et les informations d’expiration. Vous pouvez également ajouter une image au profil externe.
1. Cliquez sur **[!UICONTROL Enregistrer]**.

L&#39;administrateur peut copier l&#39;URL d&#39;inscription et l&#39;envoyer au groupe d&#39;inscription externe. Les utilisateurs externes peuvent s’inscrire, se connecter à l’application Learning Manager et accéder à leurs cours.

+++

+++Comment ajouter un questionnaire pour le retour d’informations L1 ?

Créez un questionnaire de retour d’informations que les élèves pourront utiliser une fois les cours terminés. Trois exemples de questions sont disponibles par défaut. Suivez les étapes ci-dessous pour créer un questionnaire.

1. Cliquez sur Commentaires dans le volet de gauche. Une fenêtre de questionnaire de retour d’informations s’affiche.
1. Cliquez sur **[!UICONTROL Modifier]** pour ajouter/modifier le questionnaire.

Vous pouvez ajouter un ensemble de questionnaires et choisir de ne pas les afficher si vous n’en avez pas besoin. Cochez la case pour activer/désactiver une question particulière.
...
1. Ajoutez le nom de la compétence, la description et les crédits correspondants à chaque niveau.

   Par défaut, un seul niveau avec 0 crédit sera disponible pour chaque compétence.
...
Une fois la compétence enregistrée, vous ne pouvez pas supprimer des niveaux de la compétence. L&#39;administrateur peut également affecter des élèves à une compétence et un niveau particuliers.
...
1. Saisissez le nombre de packs que vous souhaitez commander dans le champ Packs d’élèves, puis cliquez sur Passer une commande dans le coin supérieur droit de la page.
...
1. Saisissez vos coordonnées, choisissez le type de carte bancaire, indiquez les détails de la carte bancaire et cliquez sur Terminer la commande.
...
1. Ajoutez le profil, le sous-domaine et le logo de l’entreprise en cliquant sur chacune de ces options dans la page.

+++

+++Comment ajouter des cours ?

Pour ajouter des cours, vous devez changer de rôle d’auteur. Vous pouvez uniquement afficher la liste des cours disponibles en fonction de leur état en tant que **[!UICONTROL Terminé]**, **[!UICONTROL Publié]**, et **[!UICONTROL Retraité]**.
...
1. Cliquez sur Utilisateurs dans le volet de gauche après vous être connecté en tant qu’administrateur. Vous pouvez également ajouter des utilisateurs en cliquant sur Prise en main dans le volet gauche de la fenêtre et sur Ajouter des utilisateurs.
1. Pour ajouter de nouveaux utilisateurs, cliquez sur Ajouter dans le coin supérieur droit de la page.

Par défaut, tous les nouveaux utilisateurs se voient attribuer un rôle d’élève. Vous pouvez attribuer des rôles d’administrateur ou d’auteur aux élèves en cliquant sur **[!UICONTROL Actions]** dans le coin supérieur droit de la page et en choisissant **[!UICONTROL Attribuer un rôle]** > **[!UICONTROL Créer un auteur]** ou **[!UICONTROL Rendre administrateur]**.
