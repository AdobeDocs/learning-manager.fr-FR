...
>[!NOTE]
>
>La liste de tous les cours révoqués peut être affichée en cliquant sur l’onglet **Retiré**.
...
Le responsable peut visionner un aperçu des cours en cliquant sur l’option **Aperçu en tant qu’élève** tout en affichant les modules de cours.
...
1. Cliquez sur Certifications dans le volet de gauche, après vous être connecté en tant que responsable. Dans la liste de l’onglet Publié, placez le pointeur de la souris sur chaque certification et cliquez sur Inscrire des élèves. Vous pouvez également cliquer sur la vignette d’une certification publiée et cliquer sur Élèves dans le volet de gauche. Cliquez sur + Inscrire du côté droit de la page des élèves pour commencer à ajouter des élèves.
1. Vous pouvez afficher la boîte de dialogue contextuelle Inscrire des élèves après avoir cliqué sur l’option d’inscription des élèves de chacune des deux étapes ci-dessus. Commencez à saisir le nom et le profil de l’élève, puis choisissez le nom de l’élève dans la liste déroulante et cliquez sur Enregistrer.
...
Les détails de session suivants s’affichent :
